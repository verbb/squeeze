...
While the [changelog](https://github.com/verbb/squeeze/blob/craft-4/CHANGELOG.md) lists every change, this guide covers what you need to update in your templates.
